# kernel-zen.spec -- Linux ZEN kernel for Fedora / Copr
#
...
# Rust for Linux：需要 chroot 内 rustc/bindgen 满足内核 scripts/min-tool-version.sh
# 的最低版本要求（Fedora 的包名是 rust / rust-src / bindgen）。默认关闭，
# 打开前请先在目标 chroot 里实测版本。
%global _build_rust  0
