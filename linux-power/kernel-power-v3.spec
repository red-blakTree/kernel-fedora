# kernel-power-v3.spec -- 省电向 Linux 内核（基于 linux-zen）for Fedora / Copr
#
# 与 kernel-power.spec 的唯一区别：内核用 -march=x86-64-v3 编译（见 _x86_64_lvl 宏）。
...
Name:           kernel-power-v3
Summary:        Power-saving Linux kernel for Fedora (based on linux-zen, x86-64-v3 optimized)
Version:        %{_basekver}.%{_stablekver}
Release:        power%{_zenrel}.v3%{?dist}
